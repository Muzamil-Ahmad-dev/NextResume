 ...
 * * Features: * - Hero section with heading, description, features list, and CTA buttons. *
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <motion.p
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              Resume Builder is a simple, intuitive web app that helps you
              create professional resumes quickly. Choose from templates,
              customize your sections, and export your resume as PDF—all in one
              place.
            </motion.p>
